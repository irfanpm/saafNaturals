  ...
  const teamMembers = [
    {
      ...
      socialLinks: [
        { icon: 'linkedin', url: 'https://linkedin.com/in/muhammed-asru' },
        { icon: 'twitter', url: 'https://twitter.com/muhammedasru' },
      ],
    },
    {
      id: 2,
      ...
      socialLinks: [
        ...
        { icon: 'twitter', url: 'https://twitter.com/sarahkhan' },
      ],
    },
  ];
    ...
    <div className={styles.teamSection} id='owner'>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h2 className={styles.title}>Our Visionary Leaders</h2>
          <p className={styles.description}>
            Meet the passionate individuals driving Saaf Natural’s commitment to sustainability and natural excellence.
          </p>
        </div>
